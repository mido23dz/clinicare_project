...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $email_query = "SELECT email FROM doctors WHERE email = '$email' AND doctorid != $doctorid";
        ...
        if (empty($email_err)) {
            // Update the database
            $sql = "UPDATE doctors SET firstname='$firstname', lastname='$lastname', speciality='$speciality', email='$email', password='$password', address='$address', state='$state', mobile='$mobile', birthdate='$birthdate', gender='$gender', bloodgroup='$bloodgroup', photo_path='$photoPath' WHERE doctorid='$doctorid'";
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" id="speciality" name="speciality">
                                                ...
                                                <option value="Generalist" <?php if($row['speciality'] == 'Generalist') echo 'selected'; ?>>Generalist</option>
                                                <option value="Cardiologist" <?php if($row['speciality'] == 'Cardiologist') echo 'selected'; ?>>Cardiologist</option>
                                                <option value="Gynecologist" <?php if($row['speciality'] == 'Gynecologist') echo 'selected'; ?>>Gynecologist</option>
                                                <option value="Dermatologist" <?php if($row['speciality'] == 'Dermatologist') echo 'selected'; ?>>Dermatologist</option>
                                                <option value="Endocrinologist" <?php if($row['speciality'] == 'Endocrinologist') echo 'selected'; ?>>Endocrinologist</option>
                                                <option value="Gastroenterologist" <?php if($row['speciality'] == 'Gastroenterologist') echo 'selected'; ?>>Gastroenterologist</option>
                                                <option value="Neurologist" <?php if($row['speciality'] == 'Neurologist') echo 'selected'; ?>>Neurologist</option>
                                                <option value="Oncologist" <?php if($row['speciality'] == 'Oncologist') echo 'selected'; ?>>Oncologist</option>
                                                <option value="Ophthalmologist" <?php if($row['speciality'] == 'Ophthalmologist') echo 'selected'; ?>>Ophthalmologist</option>
                                                <option value="Orthopedist" <?php if($row['speciality'] == 'Orthopedist') echo 'selected'; ?>>Orthopedist</option>
                                                <option value="Pediatrician" <?php if($row['speciality'] == 'Pediatrician') echo 'selected'; ?>>Pediatrician</option>
                                                <option value="Psychiatrist" <?php if($row['speciality'] == 'Psychiatrist') echo 'selected'; ?>>Psychiatrist</option>
                                                <option value="Urologist" <?php if($row['speciality'] == 'Urologist') echo 'selected'; ?>>Urologist</option>
