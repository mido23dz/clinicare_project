                    ...
                    <div class="card">
                        <div class="all-body card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <strong>Result Date:</strong> <?php echo $tst['resultdate']; ?>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <form action="" method="POST">
                                    <div class="mb-3">
                                        <textarea class="form-control" id="results" name="results" rows="5" placeholder="Enter Results"><?php echo $results; ?></textarea>
                                    </div>
                                    <script>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <button type="submit" name="submit_results" class="btn btn-success">Save</button>
                                        <p class="ms-2"><?php echo $result_msg; ?></p>
                                    </div>
                                </form>
