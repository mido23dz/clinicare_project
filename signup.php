...
$firstname = $lastname = $email = $password = $gender = $birthdate = $state = $bloodgroup = $phone = $address = $photo_path = "";
$email_err = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email_err)) {
        ...
        if (mysqli_query($conn, $insert_query)) {
            header("location: signup-success.php"); // Redirect to signin page
        } else {
...
<div class="container">
    <div class="signup-content">
        <div class="form-container">
            ...
            <div class="dont-have">Already Have an Account? <a href="login.php">Sign In</a></div>
        </div>
