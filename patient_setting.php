...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $email_query = "SELECT email FROM patients WHERE email = '$email' AND patientid != $patientid";
        ...
        if (empty($email_err)) {
            // Update the database
            $sql = "UPDATE patients SET firstname='$firstname', lastname='$lastname', email='$email', password='$password', address='$address', state='$state', mobile='$mobile', birthdate='$birthdate', gender='$gender', bloodgroup='$bloodgroup', photo_path='$photoPath' WHERE patientid='$patientid'";
