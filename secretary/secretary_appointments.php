...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    if ($res_stat) {
        header("location: secretary_appointments.php");
    } else {
                        ...
                        <div class="all-list list box">
                            <div class="box-head head">
                                ...
                                <form action="" method="get">
                                    ...
                                    <button class="reset"><a href="secretary_appointments.php">Reset</a></button>
                                </form>
                            </div>
...
<script>
    ...
    if (confirm_result) {
        window.location.href = "secretary_appointments.php?action=" + action + "&id=" + id;
    }
    }
</script>
        <!-- End Content -->
