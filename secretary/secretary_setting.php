...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $email_query = "SELECT email FROM secretary WHERE email = '$email' AND secretaryid != $secretaryid";
        ...
        if (empty($email_err)) {
            // Update the database
            $sql = "UPDATE secretary SET firstname='$firstname', lastname='$lastname', email='$email', password='$password', address='$address', state='$state', mobile='$mobile', birthdate='$birthdate', gender='$gender', bloodgroup='$bloodgroup', photo_path='$photoPath' WHERE secretaryid='$secretaryid'";
    ...
    // Retrieve secretary information
