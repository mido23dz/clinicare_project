...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $email_query = "SELECT doctorid FROM doctors WHERE email = '$email'";
    ...
    if (empty($email_err)) {
        ...
        $insert_query = "INSERT INTO doctors (firstname, lastname, email, password, gender, birthdate, startdate, speciality, state, bloodgroup, mobile, address, photo_path) VALUES ('$firstname', '$lastname', '$email', '$password', '$gender', '$birthdate', '$startdate', '$speciality', '$state', '$bloodgroup', '$phone', '$address', '$photo_path')";
        if (mysqli_query($conn, $insert_query)) {
            $success = "success";
            $msg_success = "Doctor added successfully";
        } else {
        ...
        <div class="golobal-content add-box">
            ...
            <div class="form-container">
                ...
                <div class="head">
                    ...
                    <a href="admin_doctors.php"><i class="fa-solid fa-left-long"></i></a>
                </div>
            ...
            <div class="image-container">
                <img src="assets/img/DoctorRegistration.png" alt="Image">
            </div>
