<?php 
    ...
    $pageTitle = "Analyst Registration";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $email_query = "SELECT analystid FROM analysts WHERE email = '$email'";
    ...
    if (empty($email_err)) {
        ...
        $insert_query = "INSERT INTO analysts (firstname, lastname, email, password, gender, birthdate, startdate, speciality, state, bloodgroup, mobile, address, photo_path) VALUES ('$firstname', '$lastname', '$email', '$password', '$gender', '$birthdate', '$startdate', '$speciality', '$state', '$bloodgroup', '$phone', '$address', '$photo_path')";
        if (mysqli_query($conn, $insert_query)) {
            $success = "success";
            $msg_success = "analyst added successfully";
        } else {
        ...
        <div class="golobal-content add-box">
            ...
            <div class="form-container">
                ...
                <div class="head">
                    ...
                    <a href="admin_analysts.php"><i class="fa-solid fa-left-long"></i></a>
                </div>
            ...
            <div class="image-container">
                <img src="assets/img/analystRegistration.jpg" alt="Image">
            </div>
